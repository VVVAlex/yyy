...
class CTkMessagebox(ctk.CTkToplevel):
    ...
    def __init__(self,
                 ...
                 button_border_color: str = "default",      # ! add
                 button_border_width: int = 2,              # ! add
                 bg_color: str = "default",
                 fg_color: str = "default",
                 text_color: str = "default",
                 title_color: str = "default",
                 button_text_color: tuple = ('#111111', '#DCE4EE'),     # str = "default",
        ...
        if self.master_window is None:
            ...
            self.spawn_x = int(self.master_window.winfo_width() * .5 +
                               self.master_window.winfo_x() - .5 * self.width + 7)
            self.spawn_y = int(self.master_window.winfo_height() * .5 +
                               self.master_window.winfo_y() - .5 * self.height + 20)
        ...
        self.button_border_width = button_border_width if button_border_width < 6 else 5          # ! add
        ...
        # ! add    
        if button_border_color == "default":
            self.button_border_color = self._apply_appearance_mode(ctk.ThemeManager.theme["CTkButton"]["border_color"])
        else:
        ...
        if self.cancel_button == "cross":
            self.button_close = ctk.CTkButton(self.frame_top, corner_radius=10, width=0, height=0, hover=False,
                                              border_width=0, text="✕",
        ...
        self.title_label = ctk.CTkLabel(self.frame_top, width=1, text=self._title, text_color=self.title_color,
                                        font=self.font)
        ...
        # self.info = ctk.CTkButton(self.frame_top,  width=1, height=self.height/2, corner_radius=0, text=self.message,
        #                           font=self.font, fg_color=self.fg_color, hover=False,
        #                           text_color=self.text_color, image=self.icon)
        # self.info._text_label.configure(wraplength=self.width/2, justify="left")
        self.info = ctk.CTkLabel(self.frame_top, width=1, height=self.height / 2, corner_radius=0, text=self.message,
                                 font=self.font,
                                 fg_color=self.fg_color, text_color=self.text_color, image=self.icon, justify="left",
                                 padx=30, wraplength=self.width / 2, compound='left')
        ...
        if self.info.winfo_reqheight() > self.height / 2:
            height_offset = int((self.info.winfo_reqheight()) - (self.height / 2) + self.height)
            self.geometry(f"{self.width}x{height_offset}")
        ...
        self.button_1 = ctk.CTkButton(self.frame_top, text=self.option_text_1, fg_color=self.button_color[0],
                                      ...
                                      border_color=self.button_border_color, border_width=self.button_border_width,
        ...
        if button_width:
            ...
            columns = [5, 4, 3]
            span = 1
        self.button_1.grid(row=2, column=columns[0], columnspan=span, sticky="ew", padx=(0, 10), pady=6)
        if option_2:
            self.button_2.grid(row=2, column=columns[1], columnspan=span, sticky="ew", padx=10, pady=6)
        if option_3:
            self.button_3.grid(row=2, column=columns[2], columnspan=span, sticky="ew", padx=(10, 0), pady=6)
        ...
        self.button_1.focus()
        self.bind("<Return>", lambda e: self.button_event(self.option_text_1))
    ...
    #         self.selected_button.bind("<Return>", lambda event: self.button_event(selected_option))
